...
public class SimulatedEpsilonGreedyVBDEChooser implements SimulatedPolicyChooser{
	...
	double e			=	2.71828;
	public final static Logger logger	=	LogManager.getLogger(SimulatedEpsilonGreedyVBDEChooser.class);
	
	public SimulatedEpsilonGreedyVBDEChooser(double temperature){	//in the article delta is set to 1/#actions page 4 http://www.tokic.com/www/tokicm/publikationen/papers/AdaptiveEpsilonGreedyExploration.pdf
		super();
		this.temperature	=	temperature;
	}
	
	public SimulatedEpsilonGreedyVBDEChooser(double temperature,double delta){
		super();
		this.temperature	=	temperature;
		this.delta			=	delta;
	}
