...
public class SimulatedLinearGradientDescendSarsaLambda implements Simulation {
	...
	private SimulatedRewardCalculator rewardCalculator;
	int actions				=	4;
	int initAction;
	...
	public SimulatedLinearGradientDescendSarsaLambda(int featuresN, double epsilon, double yota, double lambda,
			SimulatedStateReader reader, SimulatedFeaturesEvaluator eval, SimulatedActionExecutor executor, SimulatedAlphaCalculator alphaCalculator,SimulatedRewardCalculator rewardCalculator,
	...
	public SimulatedLinearGradientDescendSarsaLambda(SimulatedStateReader reader, SimulatedFeaturesEvaluator eval, SimulatedActionExecutor executor,
			SimulatedAlphaCalculator alphaCalculator,SimulatedRewardCalculator rewardCalculator,int initAction,SimulationScheduler sched,SimulatedEvalIntervalManager intManager) {
		super();
		this.reader 			= 	reader;
		this.eval 				= 	eval;
		this.executor 			= 	executor;
